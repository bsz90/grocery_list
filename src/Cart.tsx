...
import { ConfirmClearCart } from "./ConfirmClearCart";
...
export const Cart = ({
  ...
  const [displayClearCart, setDisplayClearCart] = useState(false);
    ...
    <>
      <div className="absolute top-20 flex w-3/4 max-w-sm flex-col items-center justify-center py-8">
        ...
        <div className="flex h-auto w-full flex-col gap-8">
          ...
          <button
            className="flex h-16 w-full items-center justify-center rounded-xl bg-rose-500 text-white drop-shadow-lg"
            onClick={() => setDisplayClearCart(true)}
          >
            Clear All Items
          </button>
        </div>
      ...
      <ConfirmClearCart
        ...
        displayClearCart={displayClearCart}
        setDisplayClearCart={setDisplayClearCart}
        setCart={setCart}
        dispatch={dispatch}
      />
    </>
